...
"""Collect CI run/job data from GitHub API for the DCLS CVA6 CI Dashboard Version 2.
...
WORKFLOWS = {
    "ci":             "ci.yml",
    "dcls-ci-tier1-v2":  "dcls-ci-tier1-v2.yml",
    "dcls-ci-tier2-v2":  "dcls-ci-tier2-v2.yml",
}
...
def main():
    parser = argparse.ArgumentParser(description="Collect DCLS CVA6 CI Version 2 data from GitHub API")
    parser.add_argument(
        "--repo",
